package com.emanuelgabriel.projetoresttemplateapi.util;
...
public class CustomClientHttpRequestInterceptor implements ClientHttpRequestInterceptor {
	...
	private ClientHttpResponse logBodyDetails(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
			throws IOException {
		logRequestDetails(request);
